...
<section id="contact">
      <div class="container">
        <h2 class="text-center text-uppercase text-secondary mb-0">เพิ่มแมวที่จะรับฝาก</h2>
            ...
            <form  action="add_cat">
              <div class="control-group">
                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                  <label>ID</label>
                  <input class="form-control" id="id_cat" type="text" name="id_cat">
              ...
              <div class="control-group">
                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                  <label>ชื่อ</label>
                  <input class="form-control" id="name_cat" type="text" name="name_cat">
                  <p class="help-block text-danger"></p>
                </div>
              </div>
              <div class="control-group">
                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                  <label>สายพันธ์แมว</label>
                  <input class="form-control" id="breed_cat" type="breed" name="breed_cat">
                  <p class="help-block text-danger"></p>
                </div>
              </div>
              <div class="control-group">
                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                  <label>ลักษณะ</label>
                  <input class="form-control" id="nature_cat" type="nature" name="nature_cat">
                  <p class="help-block text-danger"></p>
                </div>
              </div>
              <div class="control-group">
                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                  ...
                  <input class="form-control" id="date_cat" type="date" name="date_cat">
                  <p class="help-block text-danger"></p>
                </div>
              </div>
              <div class="control-group">
                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                  ...
                  <input class="form-control" id="dates_cat" type="date" name="dates_cat">
                  <p class="help-block text-danger"></p>
                </div>
              </div>
              <br>
