...
<div class="container">
  ...
  <table class="table table-hover">
    ...
    <tbody>
      <tr>
        <td><?php echo $r['id_cat'];?></td>
        <td><?php echo $r['name_cat'];?></td>
        <td><?php echo $r['breed_cat'];?></td>
        <td><?php echo $r['nature_cat'];?></td>
        <td><?php echo $r['date_cat'];?></td>
        <td><?php echo $r['dates_cat'];?></td>
        <td><span class="glyphicon glyphicon-cog"></span> <?php echo anchor("member/edit_cat/".$r['id_cat'],"Edit")?></td>
        <td><span class="glyphicon glyphicon-trash"></span> <?php echo anchor("member/del_cat/".$r['id_cat'],"Del",array("onclick"=>"return confirm('Are you sure ?');"));?></td>
      </tr>
    </tbody>
<?php } ?>
  </table>
